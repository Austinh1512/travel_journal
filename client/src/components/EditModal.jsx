        ...
        { props.modalOptions.type === "delete" && 
            <Modal show onHide={props.toggle}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="danger" onClick={props.modalOptions.action}>Delete</Button>
                </Modal.Footer>
            </Modal>
        }
        { props.modalOptions.type === "update" && 
            <Modal show onHide={props.toggle}>
                ...
                <Modal.Body className="d-flex justify-content-center">
                    <EntryForm requestMethod="put" entryID={props.entryID} initialValues={props.initialValues} updateJournalEntry={props.modalOptions.action} toggleModal={props.toggle} />
                </Modal.Body>
            </Modal>
        }
        </>
