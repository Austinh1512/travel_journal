...
export default function PaginationNav({ totalPosts, postsPerPage, paginate, currentPage, setCurrentPage }) {
    ...
    const displayPaginationButtons = () => {
        ...
        return pageNumbers.map(number => {
            return <Pagination.Item key={number} active={number === currentPage} onClick={() => paginate(number)} color="#F55A5A" >
